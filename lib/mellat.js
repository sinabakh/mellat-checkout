...
var Mellat = function () {
  ...
  _createClass(Mellat, [{
    ...
    key: 'inquiryRequest',
    value: function inquiryRequest(_ref4, callback) {
      var _this6 = this;

      var orderId = _ref4.orderId,
          saleOrderId = _ref4.saleOrderId,
          saleReferenceId = _ref4.saleReferenceId;

      if (!callback) {
        return new Promise(function (resolve, reject) {
          _this6.inquiryRequest({ orderId: orderId, saleOrderId: saleOrderId, saleReferenceId: saleReferenceId }, function (error, res) {
            if (error) {
              return reject(error);
            }
            return resolve(res);
      ...
      return this.initializeIfNotInitialized(function (error) {
        ...
        var args = {
          ...
          saleOrderId: saleOrderId,
          saleReferenceId: saleReferenceId,
          terminalId: _this6.config.terminalId,
          userName: _this6.config.username,
          userPassword: _this6.config.password
        };
        return _this6.client.bpInquiryRequest(args, function (error, result) {
          if (error) {
            return callback(error);
          }
          return callback(null, { resCode: Number(result.return), rawResCode: result.return });
    ...
    key: 'reversalRequest',
    value: function reversalRequest(_ref5, callback) {
      var _this7 = this;

      var orderId = _ref5.orderId,
          saleOrderId = _ref5.saleOrderId,
          saleReferenceId = _ref5.saleReferenceId;

      if (!callback) {
        return new Promise(function (resolve, reject) {
          _this7.reversalRequest({ orderId: orderId, saleOrderId: saleOrderId, saleReferenceId: saleReferenceId }, function (error, res) {
            if (error) {
              return reject(error);
            }
            return resolve(res);
      ...
      return this.initializeIfNotInitialized(function (error) {
        ...
        var args = {
          ...
          saleOrderId: saleOrderId,
          saleReferenceId: saleReferenceId,
          terminalId: _this7.config.terminalId,
          userName: _this7.config.username,
          userPassword: _this7.config.password
        };
        return _this7.client.bpReversalRequest(args, function (error, result) {
          if (error) {
            return callback(error);
          }
          return callback(null, { resCode: Number(result.return), rawResCode: result.return });
